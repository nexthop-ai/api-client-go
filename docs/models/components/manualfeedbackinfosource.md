...
value := components.ManualFeedbackInfoSourceAutocomplete
```
...
| `ManualFeedbackInfoSourcePrism`              | PRISM                                        |
...
| `ManualFeedbackInfoSourceTasks`              | TASKS                                        |
| `ManualFeedbackInfoSourceTaskExecution`      | TASK_EXECUTION                               |