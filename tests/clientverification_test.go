...
func TestClientVerification_Addverificationreminder(t *testing.T) {
...
func TestClientVerification_Listverifications(t *testing.T) {
	ctx := context.Background()
...
func TestClientVerification_Verify(t *testing.T) {
	ctx := context.Background()
