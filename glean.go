...
// Generated from OpenAPI doc version 0.9.0 and generator version 2.858.2
...
func New(opts ...SDKOption) *Glean {
	sdk := &Glean{
		SDKVersion: "0.11.30",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.11.30 2.858.2 0.9.0 github.com/gleanwork/api-client-go",
