...
// Generated from OpenAPI doc version 0.9.0 and generator version 2.629.1
...
func New(opts ...SDKOption) *Glean {
	sdk := &Glean{
		SDKVersion: "0.6.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.6.4 2.629.1 0.9.0 github.com/gleanwork/api-client-go",
